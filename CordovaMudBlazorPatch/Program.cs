...
namespace CordovaMudBlazorPatch
{
    class Program
    {
        ...
        public static int PatchMudBlazorTable()
        {
            ...
            {
                Console.WriteLine("Warning: MudBlazor.min.css or MudBlazor.css not found");
                return 0;
            }
            return count;
        }
        public static int PatchMudBlazorJs()
        {
            ...
            if (count == 0)
            {
                Console.WriteLine("Warning: MudBlazor.min.js or MudBlazor.js not found");
                return 0;
            }
            return count;
        }
